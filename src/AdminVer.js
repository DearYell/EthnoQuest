      ...
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square sx={{ backgroundColor: '#7ED957' }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 10 }}>
            ...
            <Typography component="h1" variant="h5" sx={{ color: 'white', fontFamily: 'Poppins, sans-serif', fontWeight: 100, fontSize: '1.1rem',marginLeft: '-210px' }}>
                     An email with a six-digit verification<br />code has been sent to your email
            </Typography>
